-- Complete rollback migration: Remove all archive functionality
...
-- Remove archive-related columns from employees table
...
-- Remove archive-related RLS policies (if any exist)
