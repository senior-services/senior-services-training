...
-- Add furthest_watched_seconds column to video_progress
ALTER TABLE video_progress ADD COLUMN furthest_watched_seconds integer DEFAULT 0;

-- Drop and recreate the 6-arg version of update_video_progress_by_email to add p_furthest_watched_seconds
