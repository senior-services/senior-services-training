    ...
    <div className="min-h-screen bg-gradient-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center">
          <img
            src="/lovable-uploads/SS_2019_logo_Reversed.png"
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <div aria-live="polite" aria-atomic="true" className="sr-only" id="auth-errors">
              ...
              <TabsContent value="signin">
                <form onSubmit={handleSignIn} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    />
                    {emailError && (
                      <div id="email-error" className="text-body-sm text-destructive" role="alert" aria-live="polite">
                        {emailError}
                      </div>
                    )}
                    {!emailError && (
                      <div id="email-hint" className="form-additional-text">
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {!emailError && (
                      <div id="signup-email-hint" className="form-additional-text">
