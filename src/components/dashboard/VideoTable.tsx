    ...
    <div className={cn("space-y-6", className)}>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage your training content and track engagement</p>
        </div>
                ...
                {loading ? (
                  ...
                  sortedVideos.map((video, index) => (
                    ...
                    >
                            ...
                            return (
                              <div className="flex items-center justify-start gap-1.5">
                                ...
                                <span
                                  ...
                                  aria-label={`Quiz: ${quizInfo.questionCount} questions`}
                                >
                      ...
                      {/* Date Added */}
                      <TableCell className="text-left py-2">
                        <span className="text-body text-foreground">{formatShort(video.created_at)}</span>
                      </TableCell>
