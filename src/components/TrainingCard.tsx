  ...
  return <article className={cn('training-card group relative overflow-hidden focus-within:ring-2 focus-within:ring-ring', className)} aria-label={ariaLabels.card} role="article">
      <Card className="h-full flex flex-col transition-all duration-300 hover:shadow-lg">
        ...
        <header className="relative">
          ...
          {dueDateInfo && <Badge variant={dueDateInfo.variant} className={cn('absolute top-6 right-9 text-xs font-medium shadow-lg z-10 border-2', dueDateInfo.className)} aria-label={dueDateInfo.ariaLabel} role="status">
