...
export const VideoPlayerFullscreen: React.FC<VideoPlayerFullscreenProps> = ({ open, onOpenChange, videoId }) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-none w-[100vw] h-[100vh] p-0 sm:rounded-none overflow-hidden">
        <DialogHeader className="px-4 py-3 border-b">
          ...
          <DialogDescription>Watch training video</DialogDescription>
        </DialogHeader>
        <div className="w-full h-[calc(100vh-4.5rem)] bg-black">
          {loading ? (
