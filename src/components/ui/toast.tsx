...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-100 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-[.destructive]:text-destructive/50 group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive/60 group-[.destructive]:focus:ring-offset-destructive group-[.success]:text-success/70 group-[.success]:hover:text-success",
      className
    )}
    toast-close=""
    {...props}
