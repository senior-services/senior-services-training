...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left bg-gradient-card px-6 py-4 border-b border-border-secondary flex-shrink-0",
      className
    )}
    data-dialog-header
    {...props}
